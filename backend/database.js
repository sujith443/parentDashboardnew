...
// db.run(`ALTER TABLE notifications ADD COLUMN target TEXT`)
...
// Check if students table already has data
    db.get("SELECT COUNT(*) as count FROM students", (err, row) => {
      if (err) {
        ...
        // Insert student-specific notifications and faculty comments
        db.run(
          `INSERT INTO notifications (message, date, category, target) VALUES 
   ('Parent-Teacher meeting scheduled for ECE 4th year on March 25, 2025', '2025-03-11', 'Academic', 'Parents'),
   ('Rahul Sharma has been selected for campus interview with Infosys', '2025-03-10', 'Placement', 'ECE202501'),
   ('Priya Patel needs to improve attendance in Digital Signal Processing', '2025-03-09', 'Academic', 'ECE202502'),
   ('Amit Kumar has shown excellent progress in VLSI Design project', '2025-03-08', 'Academic', 'ECE202503'),
   ('Sneha Reddy has pending lab fee payment - final reminder', '2025-03-07', 'Fee', 'ECE202504'),
   ('Vikram Singh selected to represent college in technical symposium', '2025-03-06', 'Event', 'ECE202505'),
   ('Dr. Priya Sharma: Priya Patel needs to focus more on practical assignments', '2025-03-05', 'Faculty', 'ECE202502'),
   ('Dr. Rajan Verma: Amit Kumar has excellent problem-solving skills', '2025-03-04', 'Faculty', 'ECE202503'),
   ('Prof. Sunil Kumar: Sneha Reddy should improve class participation', '2025-03-03', 'Faculty', 'ECE202504'),
   ('Dr. Anil Srivastava: Vikram Singh has potential for research in VLSI', '2025-03-02', 'Faculty', 'ECE202505'),
   ('Special career counseling session for final year students on March 28', '2025-03-01', 'Career', 'All')`
        );
