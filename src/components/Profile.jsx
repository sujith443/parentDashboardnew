...
const Profile = () => {
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      const response = await axios.put("http://localhost:5000/parent/update-password", {
        email,
        oldPassword,
        newPassword,
      });
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/parent/forgot-password", {
        email,
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center mb-4">👤 Parent Profile</h2>
