  ...
  return (
    <div className="d-flex">
      ...
      <div className="container mt-4">
        <h4 className="text-center mb-4">Welcome, {fatherName}</h4>
        {/* Alerts Section */}
        {(isAttendanceLow || hasPendingFees) && (
          <div className="alert alert-warning d-flex align-items-center mb-4">
            ...
            <div>
              ...
              {hasPendingFees && "There are pending fees to be paid. "}
            </div>
          </div>
        )}
          ...
          <div className="col-md-4">
            <div className="card bg-success text-white">
              <div className="card-body text-center">
                <h3>
                  {attendance ? 
                    ((attendance?.overall.present / attendance?.overall.total) * 100).toFixed(2) + "%" : 
                    "N/A"}
                </h3>
        ...
        {/* First Row: Student Profile & Notifications */}
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="card mb-4">
              ...
              <div className="card-body">
                ...
                <Link to="/student-profile" className="btn btn-primary mt-2">
          ...
          <div className="col-md-6">
            <div className="card mb-4">
              ...
              <div className="card-body">
                <h6><strong>Father:</strong> {fatherName}</h6>
                <p className="mb-1"><strong>Occupation:</strong> {fatherOccupation}</p>
                <p className="mb-3"><strong>Phone:</strong> {fatherPhone}</p>
                
                <h6><strong>Mother:</strong> {motherName}</h6>
                <p className="mb-1"><strong>Occupation:</strong> {motherOccupation}</p>
                <p className="mb-3"><strong>Phone:</strong> {motherPhone}</p>
                
                <hr />
                
                <p className="mb-1"><strong>Email:</strong> {parentEmail}</p>
              ...
              <div className="card-body">
                {feesArray.length > 0 ? (
                  <>
                        ...
                        <tbody>
                          {feesArray.map((fee) => (
                            <tr key={fee.id}>
                              ...
                              <td>
                                {fee.due>0 && (<button className="btn btn-success" onClick={()=>setShowModal(true)}>
                                  Pay Now
                                </button>)
                    ...
                    <Link to="/fees-history" className="btn btn-primary mt-3">
        ...
        <div className="row mb-4">
          <div className="col-md-12">
            <div className="card">
              ...
              <div className="card-body">
                <p>Need to discuss your child's performance or have questions?</p>
                <div className="d-flex gap-2">
                  <Link to="/message-teacher" className="btn btn-primary">
                    Send Message
                  </Link>
                </div>
              </div>
